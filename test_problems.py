...
#print(PROBLEMS[0].state_string())
#for i in range(0,20):
   # print(PROBLEMS[i].state_string())
print(PROBLEMS[3].state_string())

#print(PROBLEMS[5].state_string())

print(PROBLEMS[13].state_string())
print(PROBLEMS[14].state_string())
print(PROBLEMS[16].state_string())
print(PROBLEMS[17].state_string())
print(PROBLEMS[19].state_string())


#print(check_destination(PROBLEMS[19]))